...
print("Su rendimiento despues de un mes es", round(rendimiento,2))
print(f"Su rendimiento despues de un mes es {rendimiento:.2f}")

total_capital = capital + rendimiento

print(f"Su nuevo saldo es {total_capital}") # Fue un complemento. 
